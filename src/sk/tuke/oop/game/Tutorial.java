 ...
 */
public class Tutorial implements RipleyState{
    
    private Hero her;
    private Game lev;
    private boolean done;
    
    public Tutorial(Hero h, Game level) {
        her = h;
        lev = level;
        done = false;
    }
